...
//  MapMission
//
//  Created by 1003487 on 2017. 7. 24..
...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    @IBAction func sgChangeLocation(_ sender: UISegmentedControl) {
        if sender.selectedSegmentIndex == 0 {
            ...
            setAnnotation(latitude: 37.142245, longitude: 127.64815440000007, delta: 0.1, title: "강동대학교", subtitle: "충청북고 음성군 감곡면 단평리 154-1")
            ...
            setAnnotation(latitude: 37.547087, longitude: 127.07282499999997, delta: 0.1, title: "코지웰", subtitle: "광진구 113-1")
            self.lblLocationInfo1.text = "보고 계신 위치"
